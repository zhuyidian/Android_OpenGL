...
import static opengl.view.Tree3DSurfaceView.UNIT_SIZE;
...
public class TreeForDraw {
	...
	public TreeForDraw(Tree3DSurfaceView mv) {
		initVertexData();
		initShader(mv);
	}
	...
	public void initVertexData() {
		vCount = 6;
		float vertices[] = new float[] { -UNIT_SIZE * 3, 0, 0, UNIT_SIZE * 3,
				0, 0, UNIT_SIZE * 3, UNIT_SIZE * 5, 0,

				UNIT_SIZE * 3, UNIT_SIZE * 5, 0, -UNIT_SIZE * 3, UNIT_SIZE * 5,
				0, -UNIT_SIZE * 3, 0, 0, };
		// 创建顶点坐标数据缓冲
		...
		float[] texcoor = new float[] { 0, 1, 1, 1, 1, 0, 1, 0, 0, 0, 0, 1 };
	...
	// 初始化shader
	public void initShader(Tree3DSurfaceView mv) {
		// 加载顶点着色器的脚本内容
