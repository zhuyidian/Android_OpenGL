...
import design.zhu.com.gl20.renderer.OpenGLRendererSquare;
import design.zhu.com.gl20.renderer.OpenGLRendererTriangle;
...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGLSurfaceView.setRenderer(new OpenGLRendererTriangle3d());
