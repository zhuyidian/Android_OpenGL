...
import design.zhu.com.gl20.common.graphics.TriangleColor;

public class OpenGLRendererTriangleColor implements Renderer {
	private TriangleColor mTriangleColor;

	public OpenGLRendererTriangleColor(){
	}
