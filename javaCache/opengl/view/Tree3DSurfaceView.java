...
public class Tree3DSurfaceView extends GLSurfaceView {
	...
	public Tree3DSurfaceView(Context context) {
		super(context);
	...
	private class SceneRenderer implements GLSurfaceView.Renderer {
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {
			...
			tg = new TreeGroup(Tree3DSurfaceView.this);
			// 初始化树顺序
			Collections.sort(mRender.tg.alist);
			desert = new Desert(Tree3DSurfaceView.this, new float[] { 0, 0, 0, 6,6, 6, 6, 6, 6, 0, 0, 0 }, 30, 20);
			// 初始化纹理
